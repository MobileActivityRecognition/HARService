...
public class SettingsActivity extends PreferenceActivity {
    ...
    public boolean isValidFragment(String fragmentName) {
        return GeneralPreferenceFragment.class.getName().equals(fragmentName) ||
                ...
                SensorListPreferenceFragment.class.getName().equals(fragmentName);
    }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class SensorListPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            for (Sensor sensor : sensorManager.getSensorList(Sensor.TYPE_ALL)) {
                ...
                checkBoxPref.setKey(String.format("sensor_%02d", sensor.getType()));
                checkBoxPref.setTitle(sensor.getName());
                checkBoxPref.setSummary(String.format("%s %d", sensor.getVendor(), sensor.getVersion()));
